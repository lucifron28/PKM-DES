-- Atomic Registrar review for pending enrollment requests.
-- Approval rules remain limited to the submitted request because PKM has not
-- supplied an official requirements or document-verification checklist.

create function public.review_pending_enrollment(
